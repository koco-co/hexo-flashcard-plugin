...
- `docs/产品需求/` 是产品行为、入口、复习阶梯和验收标准的唯一来源。
- `/Users/poco/Projects/hexo-blog` 只是集成验收宿主，不是插件源码目录。
...
- 当前博客的依赖、配置和演示内容属于独立集成步骤，不从插件仓库反向改写。
